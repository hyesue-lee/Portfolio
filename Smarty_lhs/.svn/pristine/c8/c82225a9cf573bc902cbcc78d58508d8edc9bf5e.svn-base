					...
					<ul class="hide">
						...
						<li data-transition="random" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide 1">
							...
							<div class="tp-caption customin ltl tp-resizeme text_white"
								...
								<b style="font-size:20px">이혜수</b>의 포트폴리오 사이트 입니다. :) </span>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-2">
							...
							<ul class="footer-links list-unstyled">
								...
								<li><a href="javascript:movePage(this, '/board/list.do')">게시판</a></li>
						...
						<p style="margin-bottom:0;">제가 구현한 스프링 게시판의 주요기능 확인을 위해 회원가입을 해주세요. :) <br/>
						이 사이트는 관리자 / 일반 모드를 구분하여 구현하였으며 가입시 일반회원 모드로 가입됩니다.<br/>
						<br/>
						* 임의의 관리자 계정으로 로그인하기 :  <h3> ID: admin123 / PW: admin12# </h3></p>
						</div>
			...
			<div class="sidepanel-content">
				...
				<!-- /SIDE NAV -->
							...
							<div class="mt-20">
								...
								<a href="https://github.com/hyesue-lee" target='_blank' class="social-icon social-icon-border social-gplus float-left" data-toggle="tooltip" data-placement="top" title="Google plus">
									<i class="icon-github-circled"></i>
									<i class="icon-github-circled"></i>
								</a>
								<a href="https://www.facebook.com/hyesueLee" target='_blank' class="social-icon social-icon-border social-facebook float-left" data-toggle="tooltip" data-placement="top" title="Facebook">
